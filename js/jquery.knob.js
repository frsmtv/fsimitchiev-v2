...
(function($) {
            ...
            this.o = $.extend(
                {
					...
					bColor : this.$.data('bcolor') || '#FFFFFF',
    ...
    k.Dial = function () {
        ...
        this.draw = function () {
			...
			var newRadius=this.radius-(this.lineWidth/2);
			...
			c.beginPath();
            c.arc(indicatorX, indicatorY, this.lineWidth/1.5, 0, this.PI2, false);
            c.fillStyle = this.o.bColor;
            c.fill();			
			/*Set handle knob*/
        };
